 ...
 */
public class ArabicJalalaynIndexGenerator extends IndexGenerator{
  ...
  public void createIndex(){
    createIndex(Optional.of(Translator.Arabic_Jalalayn), "./data/translation/arabic/ar.jalalayn.txt");
  }
