 ...
 */
public class UrduJunagarhiIndexGenerator extends IndexGenerator{
  ...
  public void createIndex(){
    createIndex(Optional.of(Translator.Urdu_Junagarhi), "./data/translation/urdu/ur.junagarhi.txt");
  }
...
//      term = "على";
      ...
      SearchParam searchParam = SearchParam.builder()
          .withTerm(term)
          .withTranslator(Translator.Urdu_Junagarhi)
          .withOriginal(false)
          .withPageNo(3)
          .withPageSize(32)
          .build();
...
//    term = "OR";
    try {
      Optional<Translator> translatorOptional = Optional.of(Translator.Urdu_Junagarhi);
