# Data is obtained from Tanzil.net below is the license info.
...
All text file are in tanzil.net provided format. i.e.
SURAH_ID|AYAH_ID|AYAH_TEXT

Metadata format is:
SURAH_ID|AYAH_ID|ACCM_ID|SURAH_NAME|JUZ_ID|JUZ_NAME

Extra meta information can be appended.